...
async function SearchResults({ searchParams }: SearchPageProps) {
  ...
  if (minRating) {
    ...
    productsWithRating = productsWithRating.filter(
      (product) => product.avgRating >= minRatingNum
    );
  }
  ...
  return (
    <div className="min-h-screen bg-mango1">
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1
            className={`${frederickaTheGreat.className} text-4xl text-mango4 mb-2`}
          >
            Search Results
          </h1>
          <p className="text-lg text-dark mb-2">{searchSummary}</p>
